...
const accessToken = { type: 'string', description: 'Token from login_scope; required for task changes.' };
export const AGENT_TASK_MUTATING_TOOLS = ['create_agent_task', 'update_agent_task'];
export function getAgentTaskTools() {
    return [
        {
