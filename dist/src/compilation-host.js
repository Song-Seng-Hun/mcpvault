...
export const loadCompilationHostConfig = (path, vaultPath) => loadHostWorkStorage(path, vaultPath, { namespace: 'compilation', maxStateBytes: MAX_COMPILATION_STATE_BYTES,
    maxRecordBytes: MAX_COMPILATION_STATE_BYTES, validate: validateCompilationConfig });
