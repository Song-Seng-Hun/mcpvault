...
export class DocumentSearch {
    ...
    async search(params) {
        ...
        return documentPage(items, ({ doc, publicPath, f, score }) => ({ path: publicPath, revision: doc.revision, profile: doc.profile,
            ...
            readAction: { endpointId: 'documents.read', arguments: { path: publicPath, expectedRevision: doc.revision, fragmentId: f.id, maxChars: 4000 } } }), context, fingerprint({ generations, query: params.query, path: params.path, semantic: params.semantic === true,
