...
export interface EvolutionAdapter {
    ...
    apply(cycle: Readonly<Cycle>, principal: ScopePrincipal, assertCurrent: () => Promise<void>): Promise<{
        revision: string;
    }>;
    /** Must inspect actual owner-service receipts. unknown is not permission to retry. */
    reconcile(cycle: Readonly<Cycle>, principal: ScopePrincipal, assertCurrent: () => Promise<void>): Promise<{
        state: 'applied' | 'unknown';
        revision?: string;
    }>;
    revert?(cycle: Readonly<Cycle>, principal: ScopePrincipal, assertCurrent: () => Promise<void>): Promise<{
        revision: string;
    }>;
    reconcileRevert?(cycle: Readonly<Cycle>, principal: ScopePrincipal, assertCurrent: () => Promise<void>): Promise<{
