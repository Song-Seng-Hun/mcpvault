...
export const EXPLANATION_ENDPOINTS = {
...
export function getExplanationTools() {
    return Object.entries(EXPLANATION_ENDPOINTS).map(([name, endpointId]) => {
        ...
        if (op === 'draft')
            properties.draft = { type: 'object', additionalProperties: false, required: ['blocks'], properties: {
        ...
        if (op === 'review')
            properties.review = { type: 'object', additionalProperties: false, required: ['checks'], properties: {
