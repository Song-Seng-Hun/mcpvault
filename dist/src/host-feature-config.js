...
import { DEFAULT_HOST_FEATURE_CONFIG, parseHostFeatureConfig } from './host-features.js';
...
export async function loadHostFeatureConfig(path, vaultPath) {
    if (path === undefined)
        return DEFAULT_HOST_FEATURE_CONFIG;
