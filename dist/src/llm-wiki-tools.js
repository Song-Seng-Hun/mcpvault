    ...
    return [
        ...
        },
        {
            ...
            inputSchema: { type: 'object', properties: {
                    ...
                    moc: { type: 'string', description: 'Optional Obsidian [[MOC]] link or path' }, primaryMoc: { type: 'string', maxLength: 500, description: 'Preferred Obsidian MOC entry point for this note; navigation only' }, project: { type: 'string', description: 'Optional Obsidian [[Project]] link or path' },
        ...
        },
        {
            ...
            inputSchema: { type: 'object', properties: {
                    ...
                    lifecycle: { type: 'string', enum: ['inbox', 'active', 'review', 'evergreen', 'superseded', 'archived'] },
                    moc: { type: 'string' }, primaryMoc: { type: 'string', maxLength: 500, description: 'Preferred Obsidian MOC entry point for this note; navigation only' }, project: { type: 'string' }, reviewAt: { type: 'string' },
                    ...
                    termStatus: { type: 'string', enum: ['preferred', 'deprecated', 'redirect'] }, termReplacedBy: { type: 'string', maxLength: 500 }, broaderTerms: { type: 'array', items: { type: 'string', maxLength: 500 }, maxItems: 20 }, relatedTerms: { type: 'array', items: { type: 'string', maxLength: 500 }, maxItems: 20 }, subjectTerms: { type: 'array', items: { type: 'string', maxLength: 200 }, maxItems: 20 }, domain: { type: 'string', maxLength: 200 }, methods: { type: 'array', items: { type: 'string', maxLength: 200 }, maxItems: 20 }, audience: { type: 'array', items: { type: 'string', maxLength: 200 }, maxItems: 12 }, retrievalCues: { type: 'array', items: { type: 'string', maxLength: 300 }, maxItems: 8 }, useWhen: { type: 'string', maxLength: 1000 },
                    ...
                    reviewOutcome: { type: 'string', enum: ['confirmed', 'revised', 'disputed', 'superseded', 'rescheduled'] }, reviewedBy: { type: 'string', maxLength: 200 }, reviewedAt: { type: 'string' }, reviewNote: { type: 'string', maxLength: 1000 }, interpretationStatus: { type: 'string', enum: ['unprocessed', 'interpreted', 'synthesized'], description: 'Source-processing stage' }, epistemicStatus: { type: 'string' },
                    polarity: { type: 'string', enum: ['positive', 'negative'] },
                    negativeType: { type: 'string', enum: ['failure', 'rejected', 'counterexample', 'non_reproducible', 'superseded'] },
                    attempted: { type: 'string', maxLength: 1200 }, observed: { type: 'string', maxLength: 1200 }, failureCondition: { type: 'string', maxLength: 1200 }, affectedScope: { type: 'string', maxLength: 500 }, reproduction: { type: 'string', maxLength: 1200 }, whyRejected: { type: 'string', maxLength: 1200 }, reusableLesson: { type: 'string', maxLength: 1200 }, replacementPath: { type: 'string', maxLength: 500 },
                    relations: { type: 'object', description: 'Typed Obsidian link arrays, including same_as, version_of, and refines' }, disposition: { type: 'string', enum: ['knowledge', 'reference', 'project', 'someday', 'discard', 'delegate'] }, clarifiedBy: { type: 'string' }, clarifiedAt: { type: 'string' }, clarifyNote: { type: 'string', maxLength: 1000 }, targetPath: { type: 'string' },
