...
function organizationPropertySchema(propertyName, overrides = {}) {
    ...
    if (!contract)
        throw guidanceError(new Error(`Unknown organization property contract: ${propertyName}`), 'guid-841c8f142f5dcac2');
    ...
    return [
        ...
        },
        {
            ...
            inputSchema: { type: 'object', properties: {
                    ...
                    relation: { type: 'string', enum: [...RELATION_FIELDS.filter(field => !RECIPROCAL_RELATIONS.includes(field)), 'focus_supports'], description: guidanceText('guid-4b2f6f433ca3aebe', 'Directional typed relation or focus_supports; use the reciprocal planner for related/same_as/close_match/contrasts_with') },
