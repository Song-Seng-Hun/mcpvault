...
export declare const NOTE_TEMPLATE_IDS: readonly ["atomic", "literature", "question", "hypothesis", "experiment", "assumption", "decision", "project", "moc", "negative", "synthesis", "concept", "argument", "model", "observation", "counterargument"];
