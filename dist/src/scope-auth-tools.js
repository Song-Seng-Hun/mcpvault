    ...
    return [
        {
            ...
            inputSchema: { type: 'object', properties: {
                    ...
                    accountType: { type: 'string', enum: ['personal', 'enterprise'], description: guidanceText('guid-8aa1dd76fe8ef938', 'Personal or enterprise use; must match this host. This selection never creates company authority.') },
                    departmentId: { type: 'string', maxLength: 64, description: guidanceText('guid-074c7eccaf58259a', 'Enterprise affiliation claim, checked against administrator-verified membership. Does not add departments or change the verified default navigation department.') },
