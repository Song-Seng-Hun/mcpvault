    ...
    return [
        ...
        },
        {
            ...
            inputSchema: { type: 'object', properties: {
                    ...
                    noticeId: { type: 'string', maxLength: 64, description: 'For official notice feedback, use notice.read ID with noticeRevision and proposedChange instead of sourcePaths. Reuse comments on an existing proposal.' },
                    noticeRevision: { type: 'string', maxLength: 64, description: 'Exact current notice revision being discussed. Feedback is a proposal, never direct notice-edit permission.' },
