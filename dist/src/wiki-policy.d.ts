export declare const WIKI_POLICY_TOPICS: readonly ['overview', 'onboarding', 'capture', 'retrieval', 'knowledge', 'evidence', 'review', 'work', 'moc', 'community', 'portability', 'safety'];
export type WikiPolicyTopicId = typeof WIKI_POLICY_TOPICS[number];
export declare const WIKI_POLICY_VERSION = 1;
/**
