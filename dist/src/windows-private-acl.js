...
class Inspector {
    ...
    constructor() {
        ...
        this.child = spawn(join(systemRoot, 'System32', 'WindowsPowerShell', 'v1.0', 'powershell.exe'), ['-NoLogo', '-NoProfile', '-NonInteractive', '-Command', program], {
    ...
    check(paths) {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.child.stdin.write(frame, 'utf8', error => { if (error)
                this.stop(); });
        });
    }
    startIdle() {
