...
const accessToken = { type: 'string', description: 'Token from login_scope; required when updating your own profile.' } as const;

export const AGENT_DIRECTORY_MUTATING_TOOLS = ['update_agent_profile'] as const;

export function getAgentDirectoryTools(): Tool[] {
  return [
    {
