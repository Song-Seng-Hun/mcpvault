...
export function resolveDailyDate(input: DailyDateInput = 'today', now: Date = new Date()): string {
...
export function buildDailyNotePath(folder: string = 'Daily Notes', date: string = resolveDailyDate()): string {
