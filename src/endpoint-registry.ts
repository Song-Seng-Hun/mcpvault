...
const ENDPOINT_ALIASES: Record<string, string[]> = {
  ...
  get_wiki_note_template: ['wiki', 'template', 'note template', 'atomic', 'literature', 'question', 'hypothesis', 'experiment', 'reproducible', 'decision', 'project', 'moc', 'negative', 'obsidian'],
  preview_move_note: ['move', 'rename', 'backlinks', 'links', 'impact', 'preview'],
  update_task: ['task', 'checkbox', 'gtd', 'complete', 'reopen', 'toggle'],
  get_wiki_bases_view: ['wiki', 'bases', 'obsidian', 'view', 'table', 'properties', 'experiment', 'export'],
