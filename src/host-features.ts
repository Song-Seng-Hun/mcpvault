...
export function parseHostFeatureConfig(input: unknown): HostFeatureConfig {
  ...
  if (fields.version!.value !== 1) throw new Error('Unsupported host feature configuration version');
  ...
  if (!validated.includes('wiki-core')) throw new Error('Host feature selection requires wiki-core');
