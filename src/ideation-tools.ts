  ...
  return [
    ...
    },
    {
      ...
      inputSchema: { type: 'object', properties: {
        ...
        operation: { type: 'string', enum: ['configure', 'submit', 'advance', 'handoff', 'revoke', 'pause','resume','redo', 'synthesize', 'record_output','delegate','execute_output','cancel_output','reconcile_output','close'] },
