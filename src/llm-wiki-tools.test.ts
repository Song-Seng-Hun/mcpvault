...
describe('LLM Wiki organization vocabulary contracts', () => {
  ...
  test('keeps retrieval, provenance, and epistemic schemas aligned with runtime vocabularies', () => {
    ...
    expectEnum(properties('get_wiki_canvas_view'), 'mode', ['auto', 'moc', 'neighborhood', 'workshop']);
    expectEnum(properties('export_wiki_canvas'), 'mode', ['auto', 'moc', 'neighborhood', 'workshop']);
