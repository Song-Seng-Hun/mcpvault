...
import {
  BASES_VIEW_IDS, CLARIFY_DISPOSITIONS, DECISION_STATUSES, FOCUS_HORIZONS,
  INTERPRETATION_STATUSES, ISSUE_RESOLUTION_STATUSES, ISSUE_RETROSPECTIVE_STATUSES,
  KNOWLEDGE_POLARITIES, KNOWLEDGE_ROLES, LIFECYCLES, NEGATIVE_KINDS, NOTE_KINDS,
  NOTE_TEMPLATE_IDS, RECALL_QUALITIES, RETENTION_EVENTS, RETENTION_POLICIES,
  REVIEW_CHECKS, REVIEW_OUTCOMES, REVIEW_POLICIES, SERVICE_CLASSES, TASK_STATUSES,
  TERM_STATUSES,
