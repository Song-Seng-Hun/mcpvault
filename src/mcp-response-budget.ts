...
export function enforceResponseBudget(response: any, requestedMaxChars: unknown, pulseRequest?: Record<string, unknown>): any {
...
export function normalizedResponseBudget(value: unknown, inputSchema?: Record<string, unknown>): number {
