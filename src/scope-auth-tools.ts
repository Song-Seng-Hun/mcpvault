  ...
  return [
    {
      ...
      inputSchema: { type: 'object', properties: {
        ...
        accountType: { type: 'string', enum: ['personal', 'enterprise'], description: 'Personal or enterprise use; must match this host. This selection never creates company authority.' },
        departmentId: { type: 'string', maxLength: 64, description: 'Enterprise affiliation claim, checked against administrator-verified membership. Does not add departments or change the verified default navigation department.' },
