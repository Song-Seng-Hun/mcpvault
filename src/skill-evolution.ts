...
export class SkillEvolutionService {
  ...
  private async experienceWrite(p: Params): Promise<SkillData> {
    ...
    if (used[0]!.path !== b.path || used[0]!.revision !== b.revision) throw guidanceError(Error('Used skill revision is not the current version; preserve older use privately for review'), 'guid-2a1983dd15288e20');
