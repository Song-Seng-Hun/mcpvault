...
test('security auditor real filesystem and worker regressions', () => {
  const output=execFileSync(process.execPath,['--test','--test-concurrency=1','scripts/skill-security/audit.test.mjs','scripts/skill-security/research.test.mjs','scripts/skill-security/composition.test.mjs','scripts/skill-security/boundaries.test.mjs','scripts/skill-security/library.test.mjs'],{
