...
const POLICY_TOPICS: Record<Exclude<WikiPolicyTopicId, 'overview'>, WikiPolicyTopic> = {
  ...
  review: {
    ...
    routes: ['wiki.review_packet', 'wiki.review_queue', 'wiki.review', 'wiki.exception_board', 'wiki.retention_queue', 'notes.delete_preview'],
  ...
  maintenance: {
    ...
    rules: [
      ...
      'Use notes.delete_preview before removal; prefer repair, archive, supersession, or a tombstone when any inbound body or Property reference remains.',
    ],
    routes: ['wiki.review_packet', 'wiki.exception_board', 'wiki.graph_health', 'wiki.canvas_health', 'wiki.vocabulary_health', 'wiki.duplicate_candidates', 'wiki.relation_set', 'wiki.reciprocal_link', 'wiki.moc_order', 'wiki.hierarchy_change', 'wiki.moc_membership', 'wiki.property_migration', 'notes.change_set', 'notes.delete_preview'],
