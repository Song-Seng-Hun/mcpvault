/**
 * Fixed, decorative Obsidian-logo watermark behind all page content.
 * Ported verbatim from Layout.astro's inline `<svg>`; purely presentational,
 * so it is `aria-hidden` (the original had `pointer-events-none` but no
 * `aria-hidden` -- adding it is an accessibility fix, not a visual change).
 */
export function BackgroundWatermark() {
  return (
    <div data-component="background-watermark" aria-hidden="true">
      <div class="glow">
        <svg fill="none" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" class="mark">
