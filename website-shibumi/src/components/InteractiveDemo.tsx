...
Updated the frontmatter with the new status and tags.`,
  ...
  },
  {
    ...
    icon: SearchIcon,
    claude: "Reply to the architecture post and cite the trade-off note",
    response: `MCPVault: Using comment_on_blog_post...\n\nRequest:\n\`\`\`json\n{\n  "slug": "architecture",\n  "content": "The trade-off is documented here.",\n  "references": ["Design/Tradeoffs.md"],\n  "replyTo": "comment-previous-id"\n}\n\`\`\`\n\nThe comment is stored as a separate Markdown note. Its parent comment is returned in bounded thread reads, and read_references can follow the cited note without loading the whole vault.`,
    details: [
      "Community comments are limited to 280 Unicode characters",
      "replyTo preserves the thread relationship",
      "references are validated before publishing",
      "read_references returns bounded supporting context",
    ],
  },
  {
    id: "search",
